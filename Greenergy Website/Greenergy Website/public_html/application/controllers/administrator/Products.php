                ...
                else
                {
                    ...
                    $saveData = array('title'=>$title, 
                     ...
                     if ($_FILES && $_FILES['file']['name'] !== "") {
                       ...
                       $rootPath='./uploads/products/';
                      $newFolder='./uploads/products/brochure/';
                      
                    
                     if ($_FILES && $_FILES['brochure']['name'] !== "") {
                        $field_name ='brochure';
                         $rand=rand(1,10000);
                         $config['upload_path']   = $newFolder; 
                          $config['allowed_types'] = 'pdf'; 
                          $config['remove_spaces'] = true;
                          $config['file_name']     = $rand.time().$_FILES['brochure']['name'];
                          ...
                          if (!$this->upload->do_upload('brochure')) {
                           ...
                           // $this->resizeImage($uploadedImage['file_name'], $uploadedImage['full_path'], $newFolder, 330,310);
                            if(!empty($uploadedImage['file_name'])){
                                $saveData['download_brochure']=$uploadedImage['file_name'];
                            }                          
                          }
                      }
