...
<div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-xs-12 text-right">
                <div class="form-group">
                    <a class="btn btn-primary positionModel" href="javascript:void(0);"><i class="fa fa-plus"></i> Add</a>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="box">
                ...
                <div class="box-body table-responsive no-padding">
                   <?php $this->load->view('administrator/position/table_position'); ?>  
 ...
 <div id="positionModel" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
