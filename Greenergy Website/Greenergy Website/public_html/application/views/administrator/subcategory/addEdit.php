...
?>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="box box-primary">
                    ...
                    <!-- form start -->
        <?php echo form_open('administrator/subcategory/add-edit/' . $id, array('name' => 'myform', 'method' => 'post', 'enctype' => 'multipart/form-data', 'id' => 'add-page', 'role' => 'form', 'class' => 'form-horizontal')) ?>
...
?>
    ...
    <?php echo form_error('category'); ?>
                    ...
                    <div class="form-group">
                        ...
                        <a href="<?php echo site_url('administrator/subcategory/'); ?>" class="btn btn-default">Back</a>
                        </div>
                    </div>
                    <div class="form-group">
                    </div>
