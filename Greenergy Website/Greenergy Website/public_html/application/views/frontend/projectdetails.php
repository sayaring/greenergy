                    ...
                    <div class="news-block-two blog-single-post">
                        <div class="inner-box">
                            <div class="upper-content">
                                <h3><?php echo !empty($serviceDetails['title']) ? $serviceDetails['title'] : ''; ?></h3>
                                <ul class="post-meta">
                            ...
                            <div class="lower-content">    
                                ...
                                <div class="text mb-40" style="text-align:justify"><?php echo !empty($serviceDetails['description']) ? $serviceDetails['description'] : ''; ?></div>  
                            </div>
                        </div>
                            ...
                            <form method="post">
                                <div class="row row-5">
                                    <div class="col-lg-4 col-md-6 col-sm-12 form-group">
                                        ...
                                        <input type="hidden" id="section" name="section"  value="<?php echo !empty($serviceDetails['title']) ? 'Project: '.$serviceDetails['title'] : ''; ?>">
                                    </div>
                                    <div class="col-lg-4 col-md-6 col-sm-12 form-group">
                        ...
                        <div class="news-widget widget">
                            ...
                            <div class="news-content">
                                ...
                                if(!empty($serviceDetailsMore)) {
                                  ...
                                  $url = base_url('project/'.$blogs->link);
                            ?>  
