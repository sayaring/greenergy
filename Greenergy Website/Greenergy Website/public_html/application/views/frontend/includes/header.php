        ...
        <div class="header-upper">
            <div class="auto-container">
                <div class="inner-container">
                    ...
                    <div class="logo-box">
                              <div class="logo ">
                            <a  class="logo_image" href="<?php echo base_url('/'); ?>" class="">
                                    <img src="<?php echo base_url('uploads/logo/'.IMAGE); ?>" alt="" class="logo_imag image_logo">
                            </a>
                            <!--<a href="<?php echo base_url('/'); ?>" class="">       -->
                            <!--        <img src="<?php echo base_url('uploads/logo/20_logo.jpg'); ?>" alt="" class="logo_imag1" width="120">-->
                            <!-- </a>-->
                            </div>
                    </div>
                    <div class="right-column">
