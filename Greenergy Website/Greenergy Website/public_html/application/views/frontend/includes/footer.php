                        ...
                        <div class="contact-widget widget">
                            ...
                            <ul>
                                <!--<li><i class="flaticon-location-pointer"></i>17 Royd Street, 4th Floor, Kolkata – 700016, Contact: +918250998977</li>-->
                                 <li><i class="flaticon-location-pointer"></i> Z44. 39, Chak Garia. Panchasayar. Kolkata - 700094, Contact: +918250998977</li>
        ...
        <div class="auto-container">
            <div class="wrapper-box">
                <div class="row m-0 align-items-center justify-content-between">
                    <div class="copyright-text">Copyright © <?php echo date('Y'); ?>. Greenergy Solution Pvt. Ltd. | Powered By: <a href="https://www.windhans.com/"> Wind Hans Technologies.</a></div>
                    <ul class="menu">
...
<script src="<?php echo base_url(); ?>assets/web/assets/js/script.js"></script>
    <script>
       ...
       $(document).on("click",".collegelist",function() {
        ...
        <?php
    if(isset($is_footer_js) && $is_footer_js==1){
       
?>
<script>var base_url="<?= base_url(); ?>"</script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-validate/1.19.5/jquery.validate.min.js" integrity="sha512-rstIgDs0xPgmG6RX1Aba4KV5cWJbAMcvRCVmglpam9SoHZiUCyQVDdH2LPlxoHtrv17XWblE/V/PP+Tr04hbtA==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
<script src="<?= base_url(); ?>assets/web/assets/js/applyjob.js"></script>
