        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="box box-primary">
                    ...
                    <!-- form start -->
        <?php echo form_open('administrator/news/add-edit/'.$id, array('name' =>'myform','method'=>'post','enctype'=>'multipart/form-data','id'=>'add-page','role'=>'form','class'=>'form-horizontal'))?>
                   ...
                   <div class="form-group">
                      <label class="col-lg-2 control-label">Time<span class="required">Optional</span></label>
                      <div class="col-md-8">
                    ...
                    <div class="form-group">
                      <label class="col-lg-2 control-label">Place<span class="required">Optional</span></label>
                      <div class="col-md-8">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                          <label class="col-lg-2 control-label"> Image (848 × 424)</label>
                          <div class="col-lg-5">
                    ...
                    <div class="form-group">
                        ...
                        <a href="<?php echo site_url('administrator/news/'); ?>" class="btn btn-default">Back</a>
                        </div>
                    </div>
                    <div class="form-group">
                    </div>
