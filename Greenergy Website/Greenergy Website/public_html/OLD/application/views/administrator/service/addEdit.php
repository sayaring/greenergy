        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="box box-primary">
                    ...
                    <!-- form start -->
        <?php echo form_open('administrator/services/add-edit/'.$id, array('name' =>'myform','method'=>'post','enctype'=>'multipart/form-data','id'=>'add-page','role'=>'form','class'=>'form-horizontal'))?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      <label class="col-lg-2 control-label">Product Overview<span class="required">*</span></label>
                      <div class="col-lg-8">
                        <textarea  placeholder="Enter Description" name="overview" class="cleditor" id="overview"><?php echo !empty($getData['overview']) ? $getData['overview'] : ''; ?></textarea>
                        <?php echo form_error('overview'); ?>
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-lg-2 control-label">Technical Specifications<span class="required">*</span></label>
                      <div class="col-lg-8">
                        <textarea  placeholder="Enter specification" name="specification" class="cleditor" id="specification"><?php echo !empty($getData['specification']) ? $getData['specification'] : ''; ?></textarea>
                     ...
                     <div class="form-group">
                          ...
                          <div class="col-lg-5">
                              ...
                              if(!empty($getData['image'])){
                                ...
                                $imagePath=base_url('uploads/services/thumbnail/'.$getData['image']);
                                if($getData['image']==''){
                                        $imageName = base_url('uploads/no-image.png');
                                }if(file_exists($imagePath)){
                                $imageName=base_url('uploads/services/thumbnail/'.$getData['image']);
                                } else {
                                $imageName=base_url('uploads/services/thumbnail/'.$getData['image']);
                                }
                            ?>
                    ...
                    <div class="form-group">
                        ...
                        <a href="<?php echo site_url('administrator/services/'); ?>" class="btn btn-default">Back</a>
                        </div>
                    </div>
                    <div class="form-group">
                    </div>
