                    ...
                    <?php  
                        if(!empty($projectDetails)) {
                         ...
                         $image = base_url('uploads/no-image.png');
                          ...
                          $url = base_url('project/'.$project->link);
                    ?>
                    <div class="col-lg-4 col-md-6 project-block-three">
                        <div class="inner-box">
                            <div class="image"><img src="<?php echo $image; ?>" alt="<?php echo !empty($project->title) ? $project->title: '' ?>"></div>
                            <div class="lower-content">                            
                                <h5><?php echo !empty($project->location) ? $project->location: '' ?></h5>
                                <h4><?php echo !empty($project->title) ? $project->title: '' ?></h4>
                                <div class="link-btn"><a href="<?php echo $url; ?>"><i class="flaticon-arrow-1"></i></a></div>
                            </div>
                        </div>
                    </div>
                    <?php
